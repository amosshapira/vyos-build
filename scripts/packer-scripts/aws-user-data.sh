...
# This script is executed from the UserData of the Ubuntu EC2 instance
# started by Puppet. It moves the Ubuntu root filesystem to the attached
# EBS volume under /dev/xvdf then reboot, thus leaving /dev/xvda available
# to install VyOS on it for baking by Packer.
